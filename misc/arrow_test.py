...
arrow1 = [(0, 5), (21, 5), (18, 0), (31, 10), (18, 20),
          (21, 15), (0, 15), (3, 10), (0, 5)]
...
for i in range(8):
    bbox = dev.plot(pathlist=[arrow1, [(0, tmp_fwd), (0, tmp_fwd)]], mediaheight=180, offset=(
        60, 0), bboxonly=False, end_paper_offset=-tmp_fwd+1, no_trailer=True)
    dev.wait_for_ready()
    print(i, "path done.")
    time.sleep(5)
